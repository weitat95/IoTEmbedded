...
#define NUMCOLS 24  // number of LEDs per string
#define NUMROWS 1   // number of LED strings (1<=NUMROWS<=8); strings connected to the least-significant bits of Port E
