...
*  pll.c
*
*  A software function to change the bus frequency using the PLL. This is part
*  real time operating system with minimal features.
*  ----------------------------------------------------------------------------
*  SOFTWARE DISCLAIMER
*
...
*  Jonathan Valvano    May  3, 2015           Initial/Base version (CopyRight)
